...
HD_PWD='C:/Users/thris/EdgeAccelerator/EdgeAccel/rtl/tb_fusion_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_fusion_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_fusion_top.tcl
