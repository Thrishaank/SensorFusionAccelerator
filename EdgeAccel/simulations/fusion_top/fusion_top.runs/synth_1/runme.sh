...
HD_PWD='C:/Users/thris/EdgeAccelerator/TestingLayout/fusion_top.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fusion_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fusion_top.tcl
