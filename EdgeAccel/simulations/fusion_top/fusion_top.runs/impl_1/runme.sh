...
HD_PWD='C:/Users/thris/EdgeAccelerator/TestingLayout/fusion_top.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fusion_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fusion_top.tcl -notrace
