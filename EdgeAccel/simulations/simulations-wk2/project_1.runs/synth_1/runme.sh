...
HD_PWD='C:/Users/thris/EdgeAccelerator/SET2/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_fusion.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_fusion.tcl
